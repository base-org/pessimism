...
func (m *MockEthClient) DialContext(arg0 context.Context, arg1 string) error {
	m.ctrl.T.Helper()
...
func (mr *MockEthClientMockRecorder) DialContext(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DialContext", reflect.TypeOf((*MockEthClient)(nil).DialContext), arg0, arg1)
}
