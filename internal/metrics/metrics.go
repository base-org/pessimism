...
func (m *Metrics) IncMissedBlock(PathType core.PathID) {
	m.MissedBlocks.WithLabelValues(PathType.String()).Inc()
}
...
func (m *Metrics) IncActiveHeuristics(ht core.HeuristicType, n core.Network,
	...
	m.ActiveHeuristics.WithLabelValues(ht.String(), n.String(), PathType.String()).Inc()
}
